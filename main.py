...
class Bot(BaseBot):
    ...
    async def on_chat(self, user: User, message: str) -> None:
        ...
        if message.lower() == "/Cásate conmigo?":
        ...
        if        message.startswith("Ayuda") or      message.startswith("/ayuda") or      message.startswith("!ayuda") or message.startswith("ayuda"):
            await self.highrise.chat(f"/emote lista | /pueblos | /emotes  | /Cásate conmigo? | /jugar /pez /userinfo @ | !emoteall | !tele @ | !summon @ | !kick @ | !tele z,y,x | !tele @ z,y,x | ")
